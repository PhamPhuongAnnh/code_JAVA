...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            PrintStream fileOut = new PrintStream("./minhDuc.txt");
            ...
            for (int t = 1; t <= tc; t++) {
                ...
                System.out.printf("Sum: %.2f", Practice.getsum(arr));
                System.out.println("");
                System.out.printf("Min: %.1f", Practice.getMin(arr));
                System.out.println("");
                System.out.printf("Max: %.1f", Practice.getMax(arr));
                System.out.println("");
                ...
                originalOut.printf("Sum: %.2f", Practice.getsum(arr));
                originalOut.println("");
                originalOut.printf("Min: %.1f", Practice.getMin(arr));
                originalOut.println("");
                originalOut.printf("Max: %.1f", Practice.getMax(arr));
                originalOut.println("");
