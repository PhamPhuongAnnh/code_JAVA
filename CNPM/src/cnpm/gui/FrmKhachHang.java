...
import cnpm.model.DiaChi;
import cnpm.model.KhachHang;
...
//		btnXoa.setBounds(119, 200, 120, 30);
	...
	public void mouseClicked(MouseEvent e) {
		...
		try {
			KhachHang kh = (KhachHang) khDao.layThongTinKhachHang(maKH);
			txtMa.setText(maKH + "");
			...
			DiaChi dc = (DiaChi) khDao.layThongTinDiaChi(maDC);
